...
<head>
    ...
    <title>Tambah Makanan Khas</title>
    <style>
...
<body>
<div class="container">
    <h1>Tambah Makanan Khas</h1>

    <form action="{{ route('makanan-khas.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="field">
        ...
        <div class="field">
            ...
            <input type="text" id="nama_makanan" name="nama_makanan" value="{{ old('nama_makanan') }}" maxlength="100" required>
            @error('nama_makanan') <div class="error">{{ $message }}</div> @enderror
        </div>

        <div class="field">
            <label for="deskripsi">Deskripsi (opsional)</label>
            <textarea id="deskripsi" name="deskripsi" maxlength="1000">{{ old('deskripsi') }}</textarea>
        ...
        <div class="actions">
            ...
            <a href="{{ route('makanan-khas.index', ['provinceId' => old('province_id', $selectedProvinceId)]) }}" class="btn btn-secondary">Batal</a>
        </div>
    </form>
</div>
</body>
